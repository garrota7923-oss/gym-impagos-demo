...
- Fase A terminada (A1-A5, ver HECHO.md). FASE B: B1, B2 y B2b hechos. B3a hecho. Siguiente: B3b (normalizadores). Plan nuevo B3-B8 en `examen/PLAN_IMPORTADOR.md`; `examen/` (100 archivos) solo para medir.

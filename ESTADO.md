...
- Fase A terminada (A1-A5, ver HECHO.md). FASE B: B1, B2 y B2b hechos. Siguiente: B3 (lector).
...
- Para B3: en "semana" una celda trae varios nombres (separar por / , ; -) y la marca de prueba va en el nombre concreto; en "lista" la marca de prueba puede ir en la columna de observaciones.
